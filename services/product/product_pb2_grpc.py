...
class ProductInfoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getProductDetails = channel.unary_unary(
                '/in.gore.ProductInfo/getProductDetails',
...
def add_ProductInfoServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'in.gore.ProductInfo', rpc_method_handlers)
...
class ProductInfo(object):
    ...
    def getProductDetails(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/in.gore.ProductInfo/getProductDetails',
